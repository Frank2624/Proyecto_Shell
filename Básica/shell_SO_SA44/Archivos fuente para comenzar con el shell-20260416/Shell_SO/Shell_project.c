...
// -----------------------------------------------------------------------------
//                          EJECUCIÓN COMANDOS EXTERNOS
// -----------------------------------------------------------------------------
void execute_external_commands(char **argv, int background, char *file_in, char *file_out, int *last_pid, int *retval) {
...
//                           COMANDOS EXTERNOS          
// -----------------------------------------------------------------------------
        execute_external_commands(argv, background, file_in, file_out,&last_pid,&retval);
    } // end while
    printf("\nBye\n");
    return 0;
}
